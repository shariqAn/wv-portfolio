          ...
          {(provided) => (
            ...
            >
              ...
              >
                ...
                <h2>{card.title}</h2>
                <p>{`Project: ${card.projectName === undefined ? "" : card.projectName}`}</p>
                <p>{`Client: ${card.clientName === undefined ? "" : card.clientName}`}</p>
                <p>{`Acc. Manager: ${card.accManager === undefined ? "" : card.accManager}`}</p>
